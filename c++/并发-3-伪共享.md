之前读了一篇美团点评技术博客 2016 年发表的文章：**[高性能队列——Disruptor](https://link.zhihu.com/?target=https%3A//tech.meituan.com/2016/11/18/disruptor.html)**，里面提到了 `ArrayBlockingQueue`会因为加锁和伪共享等出现严重的性能问题。
